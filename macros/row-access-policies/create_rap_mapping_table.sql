{% macro create_rap_mapping_table() %}
    {% if execute and env_var('DBT_RAP')=='Y'%}
        ...
        INSERT INTO RAP_MAPPING (POLICY_DB, POLICY_SCHEMA, POLICY_NAME, POLICY_KIND, REF_DATABASE_NAME, REF_SCHEMA_NAME, REF_ENTITY_NAME, REF_ENTITY_DOMAIN, REF_ENTITY_COLUMN, POLICY_STATUS) VALUES
